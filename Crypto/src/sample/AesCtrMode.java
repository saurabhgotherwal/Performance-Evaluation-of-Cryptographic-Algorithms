...
public class AesCtrMode {
	...
	public static final String ENCRYPTED_TEXT_FILE_SMALL = "SmallEncryptedFileCTR128.txt";
	public static final String DECRYPTED_TEXT_FILE_SMALL = "SmallDecryptedFileCTR128.txt";
	public static final String ENCRYPTED_TEXT_FILE_LARGE = "LargeEncryptedFileCTR128.txt";
	public static final String DECRYPTED_TEXT_FILE_LARGE = "LargeDecryptedFileCTR128.txt";
	...
	public static void EncryptTextFile(Cipher cipher, SecretKey secretKey, IvParameterSpec initializationVector, String PlainTextFileName, String EncryptedTextFileName) throws InvalidKeyException, InvalidAlgorithmParameterException, IOException
	{		
		...
		try{
			...
			//System.out.println("\nFile encryption completed. The content is placed in:" + EncryptedTextFileName);		
			
			System.out.println("\nTime to encrypt '"+ PlainTextFileName + "' :" + totalTime + " microseconds.");
			
			System.out.println("\nEncryption speed to encrypt '"+ PlainTextFileName + "' :" + encryptionSpeed + " bytes per microsecond.");
